...
class MySTSBenchmarkEval(object):
    def __init__(self, task_path, seed=1111):
        logging.debug('\n\n***** Transfer task : MySTSBenchmark*****\n\n')
        self.seed = seed
        # self.loadFile(os.path.join(task_path, 'sts-train.csv'))
        # self.loadFile(os.path.join(task_path, 'sts-dev.csv'))
        self.loadFile(os.path.join(task_path, 'sts-test.csv'))
